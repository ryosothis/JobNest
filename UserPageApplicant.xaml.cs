...
namespace JobNest
{
    public partial class UserPageApplicant : Page
    {
        ...
        public UserPageApplicant(int userId)
        {
            InitializeComponent();
            _userId = userId;
        }
        ...
        private async Task LoadUserData()
        {
            try
            {
                using (var connection = new NpgsqlConnection(_connectionString))
                {
                    ...
                    string userInfoQuery = "SELECT * FROM work.get_public_user_profile(@user_id)";
                    string resumeQuery = "SELECT * FROM work.get_user_resume(@user_id)";

                    using (var cmd = new NpgsqlCommand($"{userInfoQuery}; {resumeQuery}", connection))
                    {
